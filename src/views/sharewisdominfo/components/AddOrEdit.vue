<template>
  <el-dialog
    :title="rowInfo.recruit_id?'编辑当前用工信息':'发布用工信息'"
  ...
  >
    ...
    >
      ...
      <el-form-item label="薪资：" prop="salary">
        <el-input style="width:30%;" placeholder="请输入薪资" v-model="innerRowInfo.salary"></el-input>&nbsp;(元)&nbsp;每{{innerRowInfo.type==='长期'?'月':'天'}}
      </el-form-item>

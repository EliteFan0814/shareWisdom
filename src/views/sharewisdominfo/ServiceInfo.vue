<template>
  <div>
    <el-card>
      ...
      ></Spread>
      <!-- 弹出图片展示 -->
      <PicShow v-if="is_pic_show" :now_row="item" :is_service="true" @close="closeDia"></PicShow>
      <!-- 分页 -->
...
import ServiceAdOrEd from "./components/ServiceAdOrEd";

    ...
    <el-card>
      <div slot="header" :class="$style.header">
        <div :class="$style.search">
          ...
          <el-select v-model="worker_id" @clear="filterData" placeholder="选择工种" clearable>
            <el-option
              v-for="item in worker_class"
              :key="item.worker_id"
              :label="item.name"
      ...
      <el-table :data="info_data">
        ...
        <el-table-column label="佣工类型" prop="type" align="center"></el-table-column>
        <el-table-column label="薪水" prop="salary" align="center"></el-table-column>
        <el-table-column label="岗位" prop="worker_name" align="center"></el-table-column>
        <el-table-column label="推广天数" width="80" prop="spread_day" align="center"></el-table-column>
        <el-table-column label="招聘状态" prop="status_str" align="center"></el-table-column>
      ...
      <!-- 弹出 添加|编辑 器 -->
      <AddOrEdit v-if="is_edit_show" :worker_class="worker_class" :rowInfo="item" @close="closeDia"></AddOrEdit>
      <!-- 弹出推广 -->
      <Spread
        v-if="is_spread_show"
        :now_title="item"
